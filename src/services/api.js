...
export const ebayAPI = {
  ...
  saveRelistFrequency: (relistFrequencyDays, ebayAccountId) =>
    api.put('/ebay/relist-frequency', { relistFrequencyDays, ebayAccountId }),
  ...
  scheduleListing: (payload) => api.post('/ebay/scheduled-listings', payload),
  getScheduledListings: () => api.get('/ebay/scheduled-listings'),
  cancelScheduledListing: (id) => api.delete(`/ebay/scheduled-listings/${encodeURIComponent(id)}`),
