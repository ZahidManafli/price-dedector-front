...
const TAB_ALIASES = {
  ...
  marketinsight: TAB_KEYS.MARKET_INSIGHT,
  market_insight: TAB_KEYS.MARKET_INSIGHT,
  'market-insight': TAB_KEYS.MARKET_INSIGHT,
  ...
  design_studio: TAB_KEYS.DESIGN_STUDIO,
  designstudio: TAB_KEYS.DESIGN_STUDIO,
  'design-studio': TAB_KEYS.DESIGN_STUDIO,
};
